...
export function OpportunitiesPage() {
  ...
  const [applied, setApplied] = useState<{ q: string; tipo: string; dep: string }>({
    q: '',
    tipo: '',
    dep: '',
  });
  ...
  function applyFilters(e: FormEvent) {
    e.preventDefault();
    setApplied({ q: q.trim(), tipo: tipoContratacion, dep: dependencia.trim() });
    setPage(1);
  }
